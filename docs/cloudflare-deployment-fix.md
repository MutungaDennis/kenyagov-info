...
The supplied log showed missing public Supabase build variables. Runtime configuration alone does not repair data already prerendered during a build; set build variables and rebuild.
