            ...
            <div className="govuk-grid-column-two-thirds-from-desktop govuk-grid-column-full">
              ...
              <form onSubmit={handleSearchSubmit} className="govuk-form-group">
                ...
                <div className="govuk-input__wrapper">
                  ...
                  >
                    <svg width="16" height="16" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
      ...
      <li className="govuk-!-margin-top-6">
            ...
            <div className="govuk-inset-text">
              ...
              <div className="govuk-!-margin-bottom-3">
                <h4 className="govuk-heading-s govuk-!-margin-bottom-1">
                  <Link href="/politics/elections" className="govuk-link">2027 General Election timeline</Link>
                </h4>
              ...
              <div>
                <h4 className="govuk-heading-s govuk-!-margin-bottom-1">
                  <Link href="/counties/devolution" className="govuk-link">County budget and devolution</Link>
                </h4>
                <p className="govuk-body govuk-!-margin-0">
        ...
        <div className="govuk-grid-row">
          ...
          <div className="govuk-grid-column-one-third-from-desktop">
            ...
            <ul className="govuk-list">
              ...
              <li>
                <Link href="/legislature" className="govuk-link govuk-!-font-weight-bold">The Legislature</Link>
                <p className="govuk-body govuk-!-margin-top-1">National Assembly and Senate.</p>
              </li>
              <li>
                <Link href="/judiciary" className="govuk-link govuk-!-font-weight-bold">The Judiciary</Link>
                <p className="govuk-body govuk-!-margin-top-1">Supreme Court, superior courts and judicial administration.</p>
              </li>
              <li>
                <Link href="/independent-bodies" className="govuk-link govuk-!-font-weight-bold">Independent Commissions</Link>
          ...
          <div className="govuk-grid-column-one-third-from-desktop">
            ...
            <ul className="govuk-list">
              <li>
                <Link href="/counties/governors" className="govuk-link govuk-!-font-weight-bold">County Executives</Link>
                <p className="govuk-body govuk-!-margin-top-1">Governors, deputy governors and county executive committees.</p>
              </li>
              <li>
                <Link href="/counties" className="govuk-link govuk-!-font-weight-bold">County Assemblies &amp; Wards</Link>
                <p className="govuk-body govuk-!-margin-top-1">MCAs, ward-level representation, and local legislation.</p>
              </li>
              <li>
                <Link href="/counties/devolution" className="govuk-link govuk-!-font-weight-bold">Devolution</Link>
          ...
          <div className="govuk-grid-column-one-third-from-desktop">
            ...
            <ul className="govuk-list">
              <li>
                <Link href="/institutions" className="govuk-link govuk-!-font-weight-bold">Public Institutions</Link>
                <p className="govuk-body govuk-!-margin-top-1">Parastatals, regulators, and government agencies.</p>
              </li>
              <li>
                <Link href="/politics" className="govuk-link govuk-!-font-weight-bold">Politics &amp; Elections</Link>
        ...
        <div className="govuk-grid-row">
          ...
          <div className="govuk-grid-column-one-third-from-desktop">
            ...
            <ul className="govuk-list">
              <li>
                <Link href="/leaders/executive" className="govuk-link govuk-!-font-weight-bold">National executive</Link>
                <p className="govuk-body govuk-!-margin-top-1">President, Deputy President and Cabinet Secretaries.</p>
              </li>
              <li>
                <Link href="/leaders/parliament" className="govuk-link govuk-!-font-weight-bold">Members of Parliament</Link>
                <p className="govuk-body govuk-!-margin-top-1">National Assembly and Senate members.</p>
              </li>
              <li>
                <Link href="/leaders/county" className="govuk-link govuk-!-font-weight-bold">County leadership</Link>
                <p className="govuk-body govuk-!-margin-top-1">Governors, MCAs and county executives.</p>
              </li>
              <li>
                <Link href="/leaders/commissions" className="govuk-link govuk-!-font-weight-bold">Independent bodies</Link>
