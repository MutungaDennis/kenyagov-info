...
export default async function NationalAssemblyArchive({ searchParams }: PageProps) {
  ...
  try {
    ...
    let filter = `_type == "hansardSitting" && houseType == "national-assembly"`;
  ...
  // Get unique parliamentary terms for filter dropdown
        ...
        <div className="govuk-grid-row">
          <div className="govuk-grid-column-two-thirds">
            ...
            <p className="govuk-body-l">
              Official records of debates, questions, and proceedings in the National Assembly.
            </p>
          </div>
        </div>
        ...
        <div className="govuk-grid-row govuk-!-margin-bottom-6">
          <div className="govuk-grid-column-two-thirds">
            <form method="GET" className="govuk-!-margin-bottom-4">
              ...
              {(q || term) && (
                <Link href="/legislature/hansard/national-assembly" className="govuk-link govuk-!-margin-left-3">
                  Clear filters
                </Link>
              )}
            </form>
              ...
              <div className="govuk-inset-text">
                ...
                <p className="govuk-body">
                  {q || term 
                    ...
                    : "No National Assembly Hansard records have been added yet."}
                </p>
              </div>
            )}
          </div>
