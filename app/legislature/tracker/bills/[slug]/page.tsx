        ...
        <div className="govuk-grid-row">
          <div className="govuk-grid-column-two-thirds">
            ...
            <div className="govuk-!-margin-bottom-4">
              <span className={`govuk-tag ${statusClass} govuk-!-font-size-19`}>
                {bill.status}
              </span>
            </div>
            ...
            <p className="govuk-body-l">
              ...
              {bill.lastActionDate && (
                <> • Last action: <strong>{new Date(bill.lastActionDate).toLocaleDateString("en-KE", { 
                  year: "numeric", 
                  month: "long", 
                  day: "numeric" 
                })}</strong></>
            ...
            <dl className="govuk-summary-list">
              ...
              {bill.billType && (
                <div className="govuk-summary-list__row">
                  ...
                  <dd className="govuk-summary-list__value">{bill.billType}</dd>
                </div>
              )}
          ...
          <div className="govuk-grid-column-one-half">
              ...
              <>
                ...
                <div className="govuk-!-margin-bottom-4">
                  {bill.topics.map((topic, index) => (
                    <span key={index} className="govuk-tag govuk-tag--blue govuk-!-margin-right-1 govuk-!-margin-bottom-1">
                      {topic}
                    </span>
                  ))}
                </div>
            ...
            <div className="govuk-inset-text govuk-!-margin-top-2">
              <p className="govuk-body-s">
                This page shows the current status of the bill. For the most up-to-date information, 
                check the official Hansard or contact the relevant Clerk’s office.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="govuk-grid-row govuk-!-margin-bottom-8">
            <div className="govuk-grid-column-full">
              ...
              <p className="govuk-body-s govuk-!-margin-bottom-4">
                Key stages in the life of this bill
              </p>
              ...
              <div className="govuk-!-margin-bottom-4">
                {bill.timeline
                  ...
                  .map((stage, index) => (
                    <div 
                      key={index} 
                      className="govuk-summary-card govuk-!-margin-bottom-3"
                    >
                      ...
                      <div className="govuk-summary-card__content">
                        {stage.description && (
                          <p className="govuk-body-s">{stage.description}</p>
                        )}
                        {stage.notes && (
                          <p className="govuk-body-s govuk-!-font-style-italic govuk-!-margin-top-1">
                            {stage.notes}
                          </p>
                        )}
                        {stage.status && (
              ...
              <ul className="govuk-list govuk-list--bullet">
                {bill.documents.map((doc, index) => (
                  <li key={index}>
                    ...
                    {doc.uploadedAt && (
                      <span className="govuk-!-margin-left-2 govuk-body-s govuk-!-colour-muted">
            ...
            <div className="govuk-grid-column-full">
              ...
              <div className="govuk-grid-row">
                {bill.relatedBills.map((related) => {
                  const relatedStatusClass = getStatusTagClass(related.status);
                  return (
                    <div key={related._id} className="govuk-grid-column-one-half">
                      <div className="govuk-summary-card govuk-!-margin-bottom-4">
                        <div className="govuk-summary-card__title-wrapper">
                          <h3 className="govuk-summary-card__title">
                            <Link 
                              href={`/legislature/tracker/bills/${related.slug.current}`} 
                              className="govuk-link"
                            >
                              {related.billNumber}
                            </Link>
                        ...
                        <div className="govuk-summary-card__content">
                          <p className="govuk-body-s govuk-!-margin-bottom-2">{related.title}</p>
                          <span className={`govuk-tag ${relatedStatusClass}`}>
                            {related.status}
                          </span>
                        </div>
                      </div>
