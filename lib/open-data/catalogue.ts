...
export const OPEN_DATASETS: OpenDataset[] = [
  ...
  },
  {
    ...
    fields: [
      { name: "polling_station_code", description: "Station code; preserve as text" },
      { name: "name", description: "Polling station or stream name" },
      { name: "reg_centre_code", description: "Registration centre code" },
      { name: "reg_centre_name", description: "Registration centre name" },
      { name: "registered_voters_2022", description: "Registered voters in 2022; blank means unrecorded" },
      { name: "county_code", description: "County code" },
      { name: "constituency_code", description: "Constituency code" },
      { name: "ward_code", description: "Ward code" },
    ],
